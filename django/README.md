# Beyond the Fattening Room: Django Project Information
...
The project is called 'fatteningroom', but project files are stored in the 'core' folder. Please refer to core/settings.py for further details.
...
- **general** - this is for general sections of the website that don't require a data model (e.g. cookies page, accessibility page, etc.)
- **researchdata** - this is the main app that's used to manage the project's research data
...
- This project is designed to work with SQLite or a PostgreSQL database
- Details about the database can be set in core/local_settings.py


## Settings

There are 2 main settings related files:
...
- Create a local_settings.py file in each environment (must continue to be ignored by Git)
